const STATES = {
    ...
    RESTORING: 'restoring',
    UPDATING_JAR: 'updating_jar',
    PROVISIONING: 'provisioning'
};

const VALID_TRANSITIONS = {
    [STATES.STOPPED]: [STATES.STARTING, STATES.BACKING_UP, STATES.RESTORING, STATES.UPDATING_JAR],
    ...
    [STATES.CRASHED]: [STATES.STARTING, STATES.BACKING_UP, STATES.UPDATING_JAR],
    [STATES.BACKING_UP]: [STATES.STOPPED],
    [STATES.RESTORING]: [STATES.STOPPED],
    [STATES.UPDATING_JAR]: [STATES.STOPPED, STATES.CRASHED],
