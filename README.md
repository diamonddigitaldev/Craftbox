...
![version](https://img.shields.io/badge/version-1.1.0--beta.2-brightgreen?style=flat-square)
...
A common headache with Minecraft hosting is juggling Java versions, JVM flags, and potentially unsafe download pages just to get a server running.
